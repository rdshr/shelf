...
**Tests**: Include test tasks when requested in the feature specification. If
tests are not requested, tasks MUST still define explicit manual verification
steps with evidence for each user story.
...
- [ ] T004 Create a traceability matrix linking requirements to user stories and planned tasks
...
- [ ] T019 [US1] Record verification evidence in feature docs or PR notes
...
- [ ] T026 [US2] Record verification evidence in feature docs or PR notes
...
- [ ] T032 [US3] Record verification evidence in feature docs or PR notes
...
- [ ] TXXX Validate traceability matrix and constitution gates before merge
